...
### [13-20초] 가격 추적 구간 (필수! — 가격 데이터를 정확히 반영해야 합니다)
"내가 만든 사이트로 가격 추적했더니 {가격 추이}" 형태로 가격 데이터를 자연스럽게 녹여내세요.

절대 규칙: 제공된 가격 추적 데이터(현재가, 최저가, 최고가, 추이)를 반드시 정확히 반영하세요. 데이터와 다른 말을 하면 안 됩니다!

가격 상황별 대본 가이드:
- 현재가 = 최고가 (가격이 올랐을 때): "내가 만든 사이트로 가격 추적했더니 지금 최고가예요. 1월까지 OO만원대였는데 지금 XX만원까지 올랐어요. 더 오르기 전에 잡거나 아니면 가격 떨어질 때까지 제 사이트에서 추적하세요"
- 현재가 = 최저가 (저점일 때): "내가 만든 사이트로 가격 추적했더니 지금 역대 최저가예요! 이 가격 놓치면 언제 다시 올지 몰라요"
- 가격 상승 추세: "가격이 계속 오르고 있어요. OO만원에서 XX만원까지 올랐으니까 고민하면 더 비싸집니다"
- 가격 하락 추세: "가격이 떨어지고 있어요. 지금 XX만원인데 더 내려갈 수도 있으니 제 사이트에서 알림 걸어두세요"
- 가격 안정: "OO만원대에서 한동안 안정적이에요. 지금 사도 손해 볼 일 없어요"
